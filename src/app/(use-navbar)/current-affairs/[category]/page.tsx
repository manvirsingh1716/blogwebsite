...
const CategoryIndex = ({ params }: CategoryIndexProps) => {
...
const getCategoryDescription = (category: string): string => {
  const descriptions: { [key: string]: string } = {
    daily:
      "Stay updated with comprehensive daily current affairs coverage for UPSC preparation",
    monthly:
      "Access monthly magazines and compilations for in-depth UPSC preparation",
    yearly:
      "Important yearly documents and reports for UPSC Civil Services Examination",
  };

  return (
    descriptions[category] ||
    "Comprehensive current affairs coverage for UPSC preparation"
  );
};
...
const getSectionDescription = (title: string): string => {
  const descriptions: { [key: string]: string } = {
    "Daily News Analysis":
      "Comprehensive analysis of important current events with UPSC perspective",
    "The Hindu Editorial":
      "In-depth analysis of The Hindu newspaper editorials",
    "Indian Express Editorial":
      "Analysis of Indian Express editorials with UPSC relevance",
    "PIB Analysis":
      "Coverage of important government announcements and initiatives",
    "Daily MCQ Quiz": "Practice questions based on current affairs",
    "Answer Writing Practice":
      "Daily answer writing questions for Mains preparation",
...
const getCategoryFeatures = (category: string) => {
  const features: {
    [key: string]: Array<{ icon: string; title: string; description: string }>;
  } = {
    daily: [
      {
        icon: "🔄",
        title: "Daily Updates",
        description:
          "Fresh content updated every day with the latest developments",
      },
      {
        icon: "📝",
        title: "Practice Questions",
        description:
          "MCQs and answer writing questions based on daily current affairs",
      },
      {
        icon: "🎯",
        title: "UPSC Focus",
        description:
          "Content specifically curated for civil services examination",
      },
    ],
    monthly: [
      {
        ...
        description:
          "In-depth analysis of monthly magazines and current affairs",
      },
      {
        icon: "📊",
      ...
      },
      {
        ...
        description:
          "Detailed coverage of important topics from various sources",
      },
    ],
    yearly: [
      {
